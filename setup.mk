...
ifndef PSN00BSDK_LIBS
	...
	INCLUDE	= -I$(PSN00B_BASE)include/libpsn00b -I$(PSN00B_BASE)include/libpsn00b/lzp
	LDBASE	= $(PSN00B_BASE)libpsn00b/ldscripts
else
...
CFLAGS	= $(AFLAGS) -mdivide-breaks -ffreestanding -fno-builtin -nostdlib -g \
