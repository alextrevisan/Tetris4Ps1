...
struct Joystick
{
    ...
    inline unsigned char Status() const
    {
        return pad->stat;
    }

    inline unsigned char LeftStickX() const
    {
        return pad->ls_x;
    }

    inline unsigned char LeftStickY() const
    {
        return pad->ls_y;
    }

    inline unsigned char RightStickX() const
    {
        return pad->rs_x;
    }

    inline unsigned char RightStickY() const
    {
        return pad->rs_y;
    }
